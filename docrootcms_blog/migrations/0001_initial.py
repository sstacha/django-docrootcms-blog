    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='docrootcms_blog.BlogCategory')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categories', tagulous.models.fields.TagField(_set_tag_meta=True, blank=True, force_lowercase=True, help_text="Splits on commas and spaces;  hierarchy is defined by paths.  Collectively known as a 'content taxonomy'.  This is often used as headings or to organizedifferent blog content.Ex: 'sports/nfl' 'sports/mlb' 'tech/sofware/linux'NOTE: unlike tags, categories should be well thought out beforehand and not change often", to='docrootcms_blog.BlogCategory', tree=True)),
                ('properties', tagulous.models.fields.TagField(_set_tag_meta=True, blank=True, force_lowercase=True, help_text="Splits on commas and spaces; like tags but not displayed to the public.For example, you could tag posts with 'homepage' and or 'hidden' then pull all posts tagged 'homepage' but not 'hidden'", to='docrootcms_blog.BlogProperty')),
                ('tags', tagulous.models.fields.TagField(_set_tag_meta=True, blank=True, force_lowercase=True, help_text="Splits on commas and spaces; tags will be displayed to the public and used to pull a set of posts to show.  For example, you could tag posts with 'docker' 'zfs' then the plugin will show these at the bottom for visitors to use if thereare more posts with that tag.", to='docrootcms_blog.BlogTag')),
            ],
            options={
